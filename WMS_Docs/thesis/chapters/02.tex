...
\begin{itemize}
    \item \textbf{Satel} - polska firma zajmująca się produkcją systemów alarmowych, monitoringowych i kontroli dostępu, której rozwiązania opierają się o technologię RFID (ang. \english{Radio-Frequency Identification}). Możliwe jest ich wdrożenie lokalne oraz rozproszone,
