...
import com.inz.apimodels.user.get_all_users.GetAllUsersResponse;
...
public class UserController {
    ...
    public ResponseEntity<?> getAllUsers() {
        try {
            List<GetAllUsersResponse> users = userService.getAllUsers().stream().map(user -> GetAllUsersResponse.builder()
                    .id(user.getId())
